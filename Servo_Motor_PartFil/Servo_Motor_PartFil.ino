...
// Trigger a little before each phrase end so the page turn finishes on time.
...
float snapPitchToReference(float pitch){
  ...
  // Reject notes that land between semitones so C#5 does not drift into D5.
...
// flip near the end of each phrase
